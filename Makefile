...
report:
	...
	@pdflatex Projectreport.tex
profile: 
	@cd ./bin/ ; gprof cs251_base gmon.out >abc1.txt ; python3 ./../gprof2dot.py abc1.txt >abc1.dot ;dot -Tpng abc1.dot -o abc1.png
release:
	@make distclean ;make clean ; cd external/src/Box2D/ ;rm -r build251; mkdir build251 ;cd build251; cmake -DCMAKE_BUILD_TYPE=Release ../ ; cd ../../../.. ; make 
