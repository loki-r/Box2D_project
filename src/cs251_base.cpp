...
base_sim_t::base_sim_t()
{
    ...
    m_world->SetContactListener(this);
       /*! base_sim_t
        * \brief  "m_world->SetContactListener(this);" is added in this function so that the PreSolve,PostSolve,BeginContact,EndContact functions are called when needed.
        */
	m_step_count = 0;
...
// {
//   b2Fixture* a1 = contact->GetFixtureA();
//   b2Fixture* b1 = contact->GetFixtureB();

//   // int a=(a1->GetBody()->GetIntData());
//   // int b=(b1->GetBody()->GetIntData());
//   // if(a!=12){ if(b!=12){return;}b=a;a=12;}
//   // if(b==0){return;}

//   //   if(b==200){game_over=true;}
//     // if(b>0 && b<100){dele=true;num_of_object=b;}
//  }
...
void base_sim_t::step(settings_t* settings)
{
  ...
  //      {
  //         int a=(b->GetIntData());
  //           if(a==num_of_object && num_of_object!=0){m_world->DestroyBody(b);}
  //      }
  //      dele=false;
  //      num_of_object=0;
  //      }
